...
public class DownloaderActivity extends Activity implements IDownloaderClient {
    ...
    public static Long mainFileSize = 14872749L;//
     ...
     *
     *       NB:: Ici nous ne prenons pas en compte les fichier de mise de a jour
     *       cela sera gere dans un autre cas
     *
     */
    ...
    public static boolean expansionFilesDelivered(Context context) {
        for (XAPKFile xf : xAPKS) {
            ...
            {
                //System.out.println("un ou les fichiers main et ou path n existe pas");
                return false;
            }

        }
        //System.out.println("Les deux fichier main et patch existe  alors retourne vrai");
        return true;
    }
